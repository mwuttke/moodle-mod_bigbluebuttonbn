...
$opencastlticonfig = opencast::bigbluebuttonbn_check_opencast_lti_data();
if (!$opencastlticonfig) {
    print_error(get_string('view_error_missing_lti_opencast_config', 'bigbluebuttonbn'));
}
...
$opencastlticonfig['playerurl'] .= $identifier;

// Create LTI parameters.
$params = opencast::bigbluebuttonbn_create_lti_parameters_opencast($opencastlticonfig);
...
echo $opencastrenderer->render_lti_form($opencastlticonfig['ltiendpoint'], $params);
