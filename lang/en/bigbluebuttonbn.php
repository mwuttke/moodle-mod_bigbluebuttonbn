...
$string['config_opencast_instance'] = 'Opencast Instance';
$string['config_opencast_instance_description'] = 'The Opencast instance to be used by BBB for recordings, default instance would be used if 0 or empty!';
$string['config_opencast_lti_consumerkey'] = 'LTI Consumer Key';
$string['config_opencast_lti_consumerkey_description'] = 'The consumer key for performing LTI authentication, in order to show the videos in Opencast recording list section.';
$string['config_opencast_lti_consumersecret'] = 'LTI Consumer Secret';
$string['config_opencast_lti_consumersecret_description'] = 'The consumer secret for performing LTI authentication, in order to show the videos in Opencast recording list section.';
$string['config_opencast_engageurl'] = 'URL of the Opencast Engage server';
$string['config_opencast_engageurl_description'] = 'A dedicated separate URL to show the videos on the Opencast Instance. If empty, the main API URL of the Opencast Instance will be used.';
$string['config_opencast_playerurl'] = 'URL of the Opencast player';
$string['config_opencast_playerurl_description'] = 'Relative URL of the Opencast player, e.g. /engage/theodul/ui/core.html for the Theodul Pass Player.';
...
$string['view_recording_format_error_opencast_unreachable'] = 'The Opencast recording playback is unavailable at the moment.';
$string['view_error_missing_lti_opencast_config'] = 'Unable to get valid Opencast configuration in order to display the recording.';
