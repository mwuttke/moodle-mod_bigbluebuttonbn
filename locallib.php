...
function bigbluebuttonbn_create_meeting_metadata(&$bbbsession) {
    ...
    if ((boolean) \mod_bigbluebuttonbn\locallib\config::get('opencast_recording')) {
        $ocseriesid = \mod_bigbluebuttonbn\helpers\opencast::bigbluebuttonbn_check_opencast($bbbsession['course']->id);
        if ($ocseriesid != false) {
